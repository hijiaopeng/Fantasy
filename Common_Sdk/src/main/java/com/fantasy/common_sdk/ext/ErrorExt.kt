...
import com.fantasy.common_sdk.http.ResponseParseException
...
val Throwable.code: Int
    get() {
        val errorCode = when (this) {
            ...
            is ParseException -> this.errorCode.toInt()    // 业务code异常
            else -> -1
        }
        return try {
            errorCode
...
val Throwable.data: String
    get() {
        return if (this is ResponseParseException) {
            this.data ?: ""
        } else {
            ""
        }
